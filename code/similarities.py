...
class images_to_vectors_resnet18():
    def __init__(self):
        
        # Get the command line argumnet for CPU or GPU
        method = args.method

        self.device = torch.device(method) 
...
images_to_vectors = images_to_vectors_resnet18() 

allVectors = {}
print("Converting images to feature vectors:")
for image in tqdm(os.listdir(output_dir)):
    I = Image.open(os.path.join(output_dir, image)).convert("RGB")
